...
let AuthorsService = class AuthorsService {
    ...
    addAuthor(author) {
        return (0, items_helpers_1.addItem)(author, this.filePath);
    }
    editAuthor(author, id) {
        return (0, items_helpers_1.editItem)(author, id, this.filePath);
    }
    deleteAuthor(id) {
...
__decorate([
    (0, decorators_1.ModelValidation)(authors_models_1.Author),
