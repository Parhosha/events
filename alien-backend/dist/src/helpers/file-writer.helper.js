...
class JsonWriter {
    addObject(path, data) {
        const dataWithIDs = Object.assign(Object.assign({}, data), { id: (0, uuid_1.v4)() });
        return file_reader_helper_1.jsonReader.getLastCharacterPosition(path).pipe((0, operators_1.switchMap)((result) => this._addObject(path, dataWithIDs, result)), (0, operators_1.map)((result) => {
    ...
    deleteObject(path, id) {
        const tempFilePath = `${(0, uuid_1.v4)()}-temp.json`;
        let writer;
        let objectFound = 0;
        let count = 0;
        let isFirstIndex = true;
        return this.renameFile(path, tempFilePath).pipe((0, operators_1.tap)(() => (writer = fs.createWriteStream(path, { flags: 'a+' }))), (0, operators_1.switchMap)(() => file_reader_helper_1.jsonReader.getObjectByObject(tempFilePath).pipe((0, operators_1.tap)(({ parsedJsonObject, finished }) => {
            if (!finished) {
                count++;
            }
        ...
        }), (0, operators_1.filter)(({ parsedJsonObject, finished }) => finished || parsedJsonObject.id !== id), (0, operators_1.map)((objectInfo) => {
            if (isFirstIndex) {
                isFirstIndex = false;
        ...
        }))), (0, operators_1.tap)((objectInfo) => this.writeToFile(objectInfo, writer)), (0, operators_1.filter)(({ finished }) => finished), (0, operators_1.tap)(() => writer.end()), (0, operators_1.switchMap)(() => this.deleteFile(tempFilePath)), (0, operators_1.switchMap)(() => count - objectFound === 0 ? this.deleteFile(path) : (0, rxjs_1.of)(null)), (0, operators_1.map)(() => ({
    ...
    editObject(path, data, id) {
        ...
        return this.renameFile(path, tempFilePath).pipe((0, operators_1.tap)(() => (writer = fs.createWriteStream(path, { flags: 'a+' }))), (0, operators_1.switchMap)(() => file_reader_helper_1.jsonReader.getObjectByObject(tempFilePath)), (0, operators_1.map)(({ isFirstIndex, finished, parsedJsonObject }) => {
            if (finished) {
                return {
                    finished,
                };
        ...
        }), (0, operators_1.tap)((objectInfo) => this.writeToFile(objectInfo, writer)), (0, operators_1.tap)(({ parsedJsonObject }) => {
            if (!objectFound && parsedJsonObject && parsedJsonObject.id === id) {
                objectFound = parsedJsonObject;
            }
        }), (0, operators_1.filter)(({ finished }) => finished), (0, operators_1.tap)(() => writer.end()), (0, operators_1.switchMap)(() => this.deleteFile(tempFilePath)), (0, operators_1.map)(() => ({
    ...
    createJSON(path, data) {
        const dataWithId = Object.assign(Object.assign({}, data), { id: (0, uuid_1.v4)() });
        return new rxjs_1.Observable((subscriber) => {
