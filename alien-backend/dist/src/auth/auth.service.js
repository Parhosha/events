...
let AuthService = class AuthService {
    ...
    register(user) {
        ...
        return file_writer_helper_1.jsonWriter.addObject(this.filePath, userWithRole).pipe((0, operators_1.map)((result) => (Object.assign(Object.assign({}, result), { result: 'User was created.' }))), (0, operators_1.catchError)((err) => {
            if (err.message === 'Error during file reading.') {
                return file_writer_helper_1.jsonWriter
                    .createJSON(this.filePath, userWithRole)
                    .pipe((0, operators_1.map)((result) => (Object.assign(Object.assign({}, result), { result: 'User was created.' }))), (0, operators_1.catchError)((err) => (0, rxjs_1.of)(err)));
            }
            return (0, rxjs_1.of)(err);
        }));
    }
    logout(tokenWithBearer) {
        const token = (0, token_helpers_1.getTokenWithoutBearer)(tokenWithBearer);
        this.tokenService.destroy(token);
        return (0, rxjs_1.of)(null);
    }
};
__decorate([
    (0, decorators_1.ModelValidation)(auth_models_1.User),
...
AuthService = __decorate([
    ...
    __param(1, (0, common_1.Inject)(core_module_config_1.FILES_FOLDER)),
