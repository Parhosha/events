...
class User {
    constructor({ name = null, email = null, password = null }, { nameRequired = false, emailRequired = true, passwordRequired = true, } = {}) {
        ...
        this.name = {
            ...
            isValid: (name) => name && (0, common_helpers_1.isString)(name),
            type: 'string',
        };
        this.email = {
            value: email,
            ...
            isValid: (email) => email &&
                (0, common_helpers_1.isString)(email) &&
                /.+@[^@]+\.[^@]{2,}$/.test(email) &&
                (nameRequired
                    ? (0, items_helpers_1.areAllItemsExist)([email], this.filePath, 'email', true)
                    : true),
        ...
        this.password = {
            ...
            isValid: (password) => password &&
                (0, common_helpers_1.isString)(password) &&
