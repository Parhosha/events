...
let CoursesService = class CoursesService {
    ...
    getAllCourses() {
        return (0, items_helpers_1.getAllItems)(this.filePath);
    }
    getCourse(id) {
        return (0, items_helpers_1.getItem)(id, this.filePath);
    }
    ...
    addCourse(course) {
        ...
        return (0, items_helpers_1.addItem)(courseWithCreationDate, this.filePath);
    }
    editCourse(course, id) {
        return (0, items_helpers_1.editItem)(course, id, this.filePath);
    }
    deleteCourse(id) {
        return (0, items_helpers_1.deleteItem)(id, this.filePath);
    }
};
__decorate([
    (0, decorators_1.ModelValidation)(courses_models_1.Course),
...
CoursesService = __decorate([
    ...
    __param(0, (0, common_1.Inject)(core_module_config_1.FILES_FOLDER)),
