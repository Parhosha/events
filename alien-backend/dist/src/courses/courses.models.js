...
class Course {
    constructor({ title = null, description = null, duration = null, authors = null, }, { titleRequired = true, descriptionRequired = true, durationRequired = true, authorsRequired = true, } = {}) {
        ...
        this.title = {
            ...
            isValid: (title) => title && (0, common_helpers_1.isString)(title),
            type: 'string',
        };
        this.description = {
            value: description,
            required: descriptionRequired,
            isValid: (description) => description && (0, common_helpers_1.isString)(description),
            type: 'string',
        };
        this.duration = {
            value: duration,
            required: durationRequired,
            isValid: (duration) => duration && (0, common_helpers_1.isNumber)(duration),
            type: 'number',
        };
        this.authors = {
            value: authors,
            ...
            isValid: (authors) => authors &&
                authors.length &&
                (0, items_helpers_1.areAllItemsExist)(authors, this.filePath, 'id'),
            type: 'string[] and those strings must be actual IDs.',
        };
    }
    get errorStates() {
        return (0, common_helpers_1.getValidityStateOfModel)(this);
    }
}
